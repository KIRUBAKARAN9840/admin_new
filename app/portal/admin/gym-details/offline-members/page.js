...
export default function OfflineMembers() {
  ...
  const fetchClients = useCallback(async () => {
    ...
    try {
      ...
      const response = await axiosInstance.get(`/admin/gym-stats/${gymId}/offline-members`, { params });
      ...
      console.error("[OFFLINE-MEMBERS-PAGE] Error fetching clients:", error);
      setClients([]);
    } finally {
      setLoading(false);
    }
      ...
      <div className="users-container">
        <div className="users-header">
          <h2 className="users-title">
            <span style={{ color: "#FF5757" }}>O</span>ffline Members
          </h2>
        </div>
        <div
          style={{
        ...
        >
          <div style={{ textAlign: "center" }}>
            ...
            />
            <p style={{ fontSize: "14px", color: "#ccc" }}>Loading offline members...</p>
          </div>
        </div>
      </div>
    );
              ...
              {clients.length > 0 ? (
                clients.map((client) => (
                  <tr
                    ...
                    onClick={() => router.push(`/portal/admin/gym-details/offline-members/${client.client_id}?gymId=${gymId}`)}
                    style={{
                      cursor: "pointer",
                ...
                <tr>
                  <td colSpan={6} className="no-data">
                    No offline members found matching your criteria
                  </td>
                </tr>
              )}
            </tbody>
